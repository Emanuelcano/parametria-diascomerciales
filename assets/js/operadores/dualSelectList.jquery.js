(function($) {
	...
	$.fn.DualSelectList = function(parameter)
	{
		...
		this.init = function () {
			...
			this.append(
				'<div class=" left-panel" style="width: calc(50% - 5px); float: left;" ><label>Modulos disponibles</label></div>' +
				'<div class=" right-panel" style="width: calc(50% - 5px); float: left;" ><label>Modulos asignados</label></div>' +
