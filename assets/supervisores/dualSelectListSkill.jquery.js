(function ($) {
    ...
    $.fn.DualSelectList = function (parameter) {
        ...
        this.init = function () {
            ...
            this.append(
                '<div class=" left-panel" style="width: calc(50% - 5px); float: left;" ><label>Agentes disponibles</label></div>' +
                '<div class=" right-panel" style="width: calc(50% - 5px); float: left;" ><label>Agentes asignados</label></div>' +
