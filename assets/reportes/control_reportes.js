...
$('.datetimepicker').datepicker({
    ...
    $('button#btn-exportar').click(function (event){
        ...
        if ($('#sl_hasta').val() == '') {
            ...
            $.ajax({
                url: base_url + $('#frm-exportar-vencimiento').attr('action'),
                type:$('#frm-exportar-vencimiento').attr('method'),
                data:$('#frm-exportar-vencimiento').serialize(),
                beforeSend: function() {
