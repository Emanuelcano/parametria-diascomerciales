...
var cargarRespuestaBanco = function(){
    ...
    $("#btnConfirmar").on('click', function(e){
        if($("#fileRespuestaBanco").val() !== ""){
            ...
            Swal.fire({
                title: 'Esta seguro?',
                text: "Procesamiento del archivo de Respuesta Santander : "+ $("#fileRespuestaBanco").val().replace(/C:\\fakepath\\/i, ''),
                icon: 'warning',
            ...
            toastr["warning"]("Debe seleccionar un archivo valido.", "Respuesta de Santander" );
        }
    });
...
function procesarRespuestaBanco(dataRespuestaBanco){
    ...
    var url = $("input#base_url").val()+"tesoreria/tesoreria/procesarRespuestaSantander";
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'JSON',
        ...
        beforeSend : function(){
            ...
            timerSweetAlert('Procesando Respuesta Santander');
        },
        complete : function(){
        ...
        success : function(response){
            if(response.response.respuesta ){
                ...
                toastr["success"](response.response.mensaje, "Respuesta de Santander" );
                ...
                toastr["error"](message_errors, "Respuesta de Santander" );

            }else{
            	toastr["warning"](response.response.mensaje, "Respuesta de Santander" );
            }
