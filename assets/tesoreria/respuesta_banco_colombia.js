...
var cargarRespuestaBanco = function(){
    ...
    $("#btnConfirmar").on('click', function(e){
        if($("#fileRespuestaBanco").val() !== ""){
            ...
            Swal.fire({
                title: 'Esta seguro?',
                text: "Procesamiento del archivo de Respuesta Bancolombia : "+ $("#fileRespuestaBanco").val().replace(/C:\\fakepath\\/i, ''),
                icon: 'warning',
            ...
            toastr["warning"]("Debe seleccionar un archivo valido.", "Respuesta de Bancolombia" );
        }
    });
...
function procesarRespuestaBanco(dataRespuestaBanco){
    ...
    var url = $("input#base_url").val()+"tesoreria/tesoreria/procesarRespuestaBancolombia";
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'JSON',
        ...
        beforeSend : function(){
            ...
            timerSweetAlert('Procesando Respuesta Bancolombia');
        },
        complete : function(){
        ...
        success : function(response){
            if(response.response.respuesta ){
                ...
                toastr["success"](response.response.mensaje, "Respuesta de BanColombia" );
                ...
                toastr["error"](message_errors, "Respuesta de BanColombia" );

            }else{
            	toastr["warning"](response.response.mensaje, "Respuesta de BanColombia" );
            }
