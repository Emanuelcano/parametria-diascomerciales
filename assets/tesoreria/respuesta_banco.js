...
var cargarRespuestaBanco = function(){
    ...
    $("#btnConfirmar").on('click', function(e){
        if($("#fileRespuestaBanco").val() !== ""){
            ...
            Swal.fire({
                title: 'Esta seguro?',
                text: "Procesamiento del archivo de Respuesta BBVA : "+ $("#fileRespuestaBanco").val().replace(/C:\\fakepath\\/i, ''),
                icon: 'warning',
                ...
                confirmButtonText: 'Confirmar'
                  ...
                  console.log(result);
                  if (result.value) {
                      procesarRespuestaBbva(formData);
                  
                }
              })
        }else{
            toastr["warning"]("Debe seleccionar un archivo valido.", "Respuesta de BBVA" );
        }
    });

}

function procesarRespuestaBbva(dataRespuestaBanco){

    var url = $("input#base_url").val()+"tesoreria/tesoreria/procesarRespuestaBbva"
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'JSON',
        ...
        beforeSend : function(){
            ...
            timerSweetAlert('Procesando Respuesta BBVA');
        },
        complete : function(){
        ...
        success : function(response){
            if(response.response.respuesta ){
                ...
                toastr["success"](response.response.mensaje, "Respuesta de BBVA" );
                ...
                toastr["error"](message_errors, "Respuesta de BBVA" );

            }else{
            	toastr["warning"](response.response.mensaje, "Respuesta de BBVA" );
            }
