<div id="box_view_que_enviar" class="row ">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="js-example-basic-multiple" name="criterios[]" id="sl_criterios"
								multiple="multiple" style="width: 100%" placeholder="Objetivo">
