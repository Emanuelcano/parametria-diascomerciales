...
<!--  -->
	<div id="dashboard_principal" style="display: block; background: #FFFFFF;">
		<div class="box-header with-border" class="col-lg-12">
			<div class="col-md-12">
		    	<?php $this->load->view('supervisores/section_search_campanias'); ?>
			</div>
		</div>
    	<div class="col-md-12">
        	<?php $this->load->view('supervisores/table_campanias_ajax'); ?>
    	</div>
    	<br>        
        <br>
        <?php if(($this->session->userdata['tipo_operador'] == 1 || $this->session->userdata['tipo_operador'] == 2) && $desembolso != 0){ ?>            
            <div class="col-md-12">
