                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="display: flex;">
                                        ...
                                        <input type="number" value="<?php echo (strtoupper($config[0]->min_proceso_obligatorio)) ?>" class="form-control" id="minProcesoObligatorio" placeholder="Ingrese en minutos la duración. Ej: 30" autocomplete="off">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="display: flex;">
                                        ...
                                        <input type="number" value="<?php echo (strtoupper($config[0]->dias_busqueda)) ?>" class="form-control" id="diasBusqueda" placeholder="Ingrese los días para buscar solicitudes. Ej. 4" autocomplete="off">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="display: flex;">
                                        ...
                                        <input type="text" value="<?php echo (strtoupper($config[0]->min_gestion)) ?>" class="form-control" id="minGestion" placeholder="Ingrese en minutos el tiempo de gestión. Ej 30" autocomplete="off">
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-6">                                
								...
								<label for="estado" class="col-sm-4 control-label has-tip" data-tip="Tiempo de espera para que el operador empiece a procesar las solicitudes obligatorias">Tiempo de preparación</label>
									<div class="col-sm-8" style="display: flex;">
                                        ...
                                        <input type="number" value="<?php echo (strtoupper($config[0]->seg_ejecucion)) ?>" class="form-control" id="segEjecucion" placeholder="Segundos de preparación" autocomplete="off" disabled>               
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="display: flex;">
                                        ...
                                        <input type="number" value="<?php echo (strtoupper($config[0]->segundos_alert_ext)) ?>" class="form-control" id="segundosAlerta" placeholder="Segundos de alerta y extensión" autocomplete="off" disabled>
                                    </div>
                                </div>
