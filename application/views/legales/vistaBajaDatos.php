...
<h2 id="titulo" align="center">Baja de Datos <a id="btn_descargar" class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i></a></h2>
<br><br>
<div class="container">
        ...
        <form action="<?php base_url();?>legales/Legales/dar_baja" method="post" id="frm_dar_baja" name="frm_dar_baja">
            <table id="clientes" class="table-striped">
                <thead class="cabeza">
                    ...
                    <td scope="col" id="adjuntar_bajaDatos" class="adjuntar_bajaDatos" style="display:none"><i class="fa fa-file-archive-o " aria-hidden="true"></i><strong> Comprobante</strong></td>
...
<div class="modal fade" id="myModalAdjuntarBajaDatos" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modalAdjuntarBajaDatos modal-dialog">
        <div class="modal-content">
            <div class="modalCabeceraBajaDatos modal-header">
                ...
                <div class="contenido_modal container-fluid">
                    ...
                    <div class="div_archivo">
                                <div>
                                    ...
                                    <td><input class="inp_adjuntarBajaDatos form-control" type="file" multiple name="file[]" value="" id="file"></td>
                                </div>
                            </div>
                        </form>
                        </div>
                <div class="pieModalBajaDatos modal-footer">
...
<script type="text/javascript" src="<?php echo base_url('assets/legales/BajaDatos.js');?>" ></script>
