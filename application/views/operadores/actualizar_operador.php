                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="pila" placeholder="Nombre de pila"   value="<?php echo $data['operador']->nombre_pila; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="telefono"   placeholder="Tel&eacute;fono" value="<?php echo $data['operador']->telefono_fijo; ?>">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="telefono_ext"   placeholder="Extension" value="<?php echo $data['operador']->extension; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="telefono_wapp"   placeholder="Whatsapp" value="<?php echo $data['operador']->wathsapp; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="email"   placeholder="Correo Electronico" value="<?php echo $data['operador']->mail; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group automaticas <?php echo ($data['operador']->tipo_operador == '11')? '': 'hide'; ?>">
                                      ...
                                      <div class="col-sm-10">
                                        <select class="form-control" id="automaticas" name="automaticas" >
                                                <option value="1" <?php if($data['operador']->automaticas == '1'){echo "selected"; }?>>Activo</option>
                                                <option value="0" <?php if($data['operador']->automaticas == '0'){echo "selected"; }?>>Inactivo</option>
                                        </select>
                                    </div>
                                  </div> 
