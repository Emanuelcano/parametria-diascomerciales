<div id="box_real_extinguido" class="box box-info">
	<div class="box-header with-border gs_real_extinguido" id="titulo">
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-12" style="text-align: center; color: #22b14c">
					<strong>SECTOR REAL EXTINGUIDO</strong>
				</div>
			</div>
		</div>
	</div>
