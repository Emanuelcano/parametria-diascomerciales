<div class="box box-info">
    ...
    <div id="div_referencia_personal">
     ...
     <input hidden id="referencia_tipo_personal" value="FUERZAS ARMADAS">
    ...
    <div class="box-header with-border" id="titulo">
        <h6 class="box-title"><small><strong>Referencia Fuerzas Armadas</strong></small></h6>
        <i style="float: right; font-size: 20px; margin-right: 8px; color: green" onclick="agregar_referencia_personal(<?php echo $ref_personal[0]['id'] ?>,'laboral')" title="Agregar Nueva Referencia" class="verif fa fa-plus-square"></i>
    </div>
    <?php if(isset($ref_personal[0])): ?>
    <table class="table table-striped table=hover display" id="tabla_vista_personal" width="100%">
        <tbody>
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Batallon</td>
            ...
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Rango</td>
                <td class="analisis_col_der">
                    <strong id="empresa_cargo"><?php echo  isset($ref_personal[0]['empresa_cargo'])?$ref_personal[0]['empresa_cargo']:'' ?></strong>
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Dirección</td>
                <td class="analisis_col_der">
                    <strong><?php echo  isset($ref_personal[0]['empresa_direccion'])?$ref_personal[0]['empresa_direccion']:'' ?></strong>
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Antigüedad</td>
                <td class="analisis_col_der">
                    <strong><?php echo  isset($ref_personal[0]['empresa_barrio'])?$ref_personal[0]['empresa_barrio']:'' ?></strong>
                </td>
            </tr>
            <tr>
    ...
    <table class="table table-striped table=hover display" id="tabla_agregar_personal" hidden width="100%">
        <tbody>
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Batallon</td>
                <td class="analisis_col_der">
                    <input type="text" id="nombre_apellido_personal"  class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Telefono</td>
            ...
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Rango</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_cargo" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Dirección</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_direccion" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Antigüedad</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_barrio" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>            
            <tr>
                <td class="analisis_col_izq" style="text-align: right;"></td>
                <td class="analisis_col_der"> 
                    <button class="btn btn-success pull-right" data-id-referencia="" referencia="laboral" onclick="registrar_personal(this)" id="registrar_personal">REGISTRAR</button>                 
                </td>
            </tr>           
        </tbody>
    </table>
