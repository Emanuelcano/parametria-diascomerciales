<style>
	...
	.accordion_referencias_cruzadas {
	...
	.accordion_referencias_cruzadas:hover {
		background-color: #c8bef6;
	}

	.accordion_referencias_cruzadas.active {
		background-color: #c8bef6;
	}
	.active.accordion_gest_st_ila:after,
	.active.accordion_gest_st_ilt:after,
	.active.accordion_referencias_cruzadas:after {
		content: "\2B9E";
	}
	.accordion_gest_st_ila:after,
	.accordion_gest_st_ilt:after,
	.accordion_referencias_cruzadas:after {
		content: "\2B9F";
		color: black;
		font-weight: bold;
		float: right;
...
<div id="box_info_endeudamiento" class="box box-info">
	...
	<div class="box-body" style="font-size: 12px;">
		<div class="container-fluid">
			<div class="row">		
				<button class="col-sm-12 text-center accordion_referencias_cruzadas">
					<h4 class="title_button_info_endeudamiento">VER REFERENCIAS CRUZADAS</h4>
				</button>
				<div class="panel_10" style="display:none;">
					<div class="container-fluid" id="referencias_cruz">
						<div id="info4">
							<div>
								<div id="infoLoadingReferencias">
								...
								<div id="referencia_cruzadas" style="display: none"></div>
							</div>
						</div>
					</div>
				</div>
