<div class="box box-info">
    ...
    <table class="table table-striped table=hover display" id="tabla_vista_personal" width="100%">
        <tbody>
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Empresa</td>
            ...
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Cargo</td>
                <td class="analisis_col_der">
                    <strong><?php echo  isset($ref_personal[0]['empresa_cargo'])?$ref_personal[0]['empresa_cargo']:'' ?></strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="analisis_col_izq" style="text-align: right;">Barrio</td>
                <td class="analisis_col_der">
    ...
    <table class="table table-striped table=hover display" id="tabla_agregar_personal" hidden width="100%">
        <tbody>
            ...
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Cargo</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_cargo1" value="" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Dirección</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_direccion" value="" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>
            <tr>
                <td class="analisis_col_izq" width="30%" style="text-align: right;">Barrio</td>
                <td class="analisis_col_der">
                    <input type="text" id="empresa_barrio" value="" class="agregar_referencia_personal" autocomplete="off">
                </td>
            </tr>            
            <tr>
