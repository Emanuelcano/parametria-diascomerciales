                        ...
                        <form class="form-horizontal" id="formDatosBasicos" action="<?php echo base_url()?>api/ApiGastos/actualizar_gasto" method="POST">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="exento" value="<?php echo $data['cargar_gasto'][0]['exento']; ?>" <?php echo $disabled ?> type="number" step="0.01" class="form-control calculaTotal" id="exento" placeholder="Exento" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="sub_total" value="<?php echo $data['cargar_gasto'][0]['sub_total']; ?>" <?php echo $disabled ?> type="number" step="0.01" class="form-control calculaTotal" id="sub_total" placeholder="Sub-Total" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="impuesto" value="<?php echo $data['cargar_gasto'][0]['impuesto']; ?>" <?php echo $disabled ?> type="number" step="0.01" class="form-control calculaTotal" id="impuesto" placeholder="Impuesto" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="impuesto_consumo" value="<?php echo $data['cargar_gasto'][0]['impuesto_consumo']; ?>" <?php echo $disabled ?> type="number" step="0.01" class="form-control calculaTotal" id="impuesto_consumo" placeholder="Impuesto Consumo" style="text-align: right;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input type="number" value="<?php echo $data['cargar_gasto'][0]['retefuente']; ?>" <?php echo $disabled ?> step="0.01" class="form-control calculaTotal" id="retefuente" name="retefuente" placeholder="Retefuente" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input type="number" value="<?php echo $data['cargar_gasto'][0]['reteica']; ?>" <?php echo $disabled ?>  step="0.01" class="form-control calculaTotal" id="reteica" name="reteica" placeholder="Reteica" style="text-align: right;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="descuento" value="<?php echo $data['cargar_gasto'][0]['descuento']; ?>" <?php echo $disabled ?> type="number" step="0.01" class="form-control calculaTotal" id="descuento" placeholder="Descuento" style="text-align: right;">
                                        </div>
                                    </div>		                            
                                    <div class="form-group">
                                        <label for="total_pagar" class="col-sm-4 control-label">Total a Pagar</label>
                                        <div class="col-sm-6">
                                            <input readonly type="number" step="0.01" class="form-control" id="total_pagar"  name="total_pagar" placeholder="Total a pagar" style="text-align: right;" value="<?php echo $data['cargar_gasto'][0]['total_pagar']; ?>" >
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-sm-6">                                                              
                                       ...
                                       <input  name="file" id="file" type="file" class="form-control file">
                                        <p style="font-size: 20px;">
                                            <a href="<?php echo base_url($data['cargar_gasto'][0]['url_archivo']) ?>" target="_blank">
                                                <i  class="fa fa-search-plus"></i> Ver Documento
                                            </a>
                                        </p> 
                                       <div class="modal fade" id="fotoGrande" tabindex="-1" role="dialog" aria-labelledby="detallePaso" aria-hidden="true">
                                        <div class="modal-dialog" role="document" style="width: 70%; height: 70%">
                                          <div class="modal-content">
                                            <div class="modal-header">                                              
                                            </div>
                                            <div class="modal-body">     
                                            <?php $extension = substr($data['cargar_gasto'][0]['url_archivo'], -3); 
                                                  if ($extension == "pdf"){
                                            ?>
                                                   <embed src="<?php echo isset($data['cargar_gasto'][0]['url_archivo'])?base_url($data['cargar_gasto'][0]['url_archivo']):''; ?>"   style="height: -webkit-fill-available;width:100%" />
                                            <?php } else {
                                            ?>
                                                    <img src="<?php echo isset($data['cargar_gasto'][0]['url_archivo'])?base_url($data['cargar_gasto'][0]['url_archivo']):''; ?>"   style="height: unset;width:100%" />
                                            <?php } ?>
                                                    </div>
                            ...
                            <div class="col-sm-12 pull-right" id="divMensajes" style="display: none;">
                             ...
                             <div class="modal-foote" style="text-align: center">
                                <a href="#" data-dismiss="modal" id="aprobar" class="btn btn-success updateEstadoGasto" data-id="<?php echo $data['cargar_gasto'][0]['id_gasto']?>" data-estado ="3" onclick="updateEstadoGasto(this)">APROBADO</a>
                                <a href="#" data-dismiss="modal" id="rechazar" class="btn btn-danger updateEstadoGasto" data-id="<?php echo $data['cargar_gasto'][0]['id_gasto']?>" data-estado ="4" onclick="updateEstadoGasto(this)">RECHAZADO</a>
                            
   
                                <a href="#" data-dismiss="modal" class="btn btn-info" onclick="administrarGastos()">VOLVER</a>
                            </div>
                            <!--onclick="anularGasto(' + row.estado + ',' + row.id_gasto + ');">--!>
                            <!-- /.box-footer -->
                        </form>
                    </fieldset>
                </div>
